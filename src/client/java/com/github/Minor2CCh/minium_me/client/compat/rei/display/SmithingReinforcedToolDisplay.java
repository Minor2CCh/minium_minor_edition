...
public class SmithingReinforcedToolDisplay extends DefaultSmithingDisplay {

    private final SmithingToolReinforcedRecipe recipe;

    public SmithingReinforcedToolDisplay(RecipeEntry<SmithingToolReinforcedRecipe> entry) {
    ...
    public List<EntryIngredient> getOutputEntries() {
        ...
        for(ItemStack stack : recipe.base.getMatchingStacks()){
            ...
            result.set(MiniumModComponent.TOOL_REINFORCED, recipe.reinforced);
