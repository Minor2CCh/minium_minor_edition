...
public class MiniumItem{
    ...
    public static final Item MINIUM_MULTITOOL = register(new MiniumMultiToolItem(MiniumToolMaterial.MINIUM_TOOL, new Item.Settings().attributeModifiers(MiniumMultiToolItem.createAttributeModifiers(MiniumToolMaterial.MINIUM_TOOL, 1.5f, -2.0f))), "minium_multitool");
    ...
    public static final Item C_MINIUM_MULTITOOL = register(new MiniumMultiToolItem(MiniumToolMaterial.C_MINIUM_TOOL, new Item.Settings().attributeModifiers(MiniumMultiToolItem.createAttributeModifiers(MiniumToolMaterial.C_MINIUM_TOOL, 1.5f, -2.0f))), "concentrated_minium_multitool");
    ...
    public static final Item IRIS_QUARTZ_MULTITOOL = register(new MiniumMultiToolItem(MiniumToolMaterial.IRIS_QUARTZ_TOOL, new Item.Settings().attributeModifiers(MiniumMultiToolItem.createAttributeModifiers(MiniumToolMaterial.IRIS_QUARTZ_TOOL, 1.5f, -2.0f)).rarity(Rarity.EPIC).fireproof()), "iris_quartz_multitool");
    //armor
    ...
    public static final Item IRIS_QUARTZ_ELYTRA = register(new IrisQuartzElytraItem(new Item.Settings().maxDamage(MiniumConfigLoader.getConfig().getDurabilityIrisQuartzElytra()).rarity(Rarity.EPIC).fireproof()),"iris_quartz_elytra");
    public static final Item IRIS_QUARTZ_ELYTRA_CHESTPLATE = register(new ElytraChestplateItem(MiniumArmorMaterial.IRIS_QUARTZ, ArmorItem.Type.CHESTPLATE, new Item.Settings().maxDamage(MiniumConfigLoader.getConfig().getDurabilityIrisQuartzElytra()).rarity(Rarity.EPIC).fireproof()),"iris_quartz_elytra_chestplate");
    ...
    public static final Item ENERGY_GUN = register(new MiniumGunItem(new Item.Settings().maxCount(1).component(MiniumModComponent.REMAIN_ENERGY, EnergyComponent.getDefaultComponent()).component(MiniumModComponent.GUN_RELOAD, new GunReloadComponent(0, ItemStack.EMPTY))), "energy_gun");
    ...
    public static final Item WIND_EXPLODER = register(new WindExploderItem(new Item.Settings().maxDamage(MiniumConfigLoader.getConfig().getDurabilityWindExploder())), "wind_exploder");
    public static final Item ADVANCED_WIND_EXPLODER = register(new WindExploderItem(new Item.Settings().maxDamage(MiniumConfigLoader.getConfig().getDurabilityAdvancedWindExploder()).fireproof()), "advanced_wind_exploder");
    ...
    public static final Item IRIS_QUARTZ_MACE = register(new IrisQuartzMaceItem(new Item.Settings()
            .fireproof()
            .rarity(Rarity.EPIC)
            .maxDamage(MiniumConfigLoader.getConfig().getDurabilityIrisQuartzMace())
