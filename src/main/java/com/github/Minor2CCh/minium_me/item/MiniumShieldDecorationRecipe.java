...
public class MiniumShieldDecorationRecipe extends SpecialCraftingRecipe {
    public MiniumShieldDecorationRecipe(CraftingRecipeCategory category) {
        super(category);
    }
        ...
        for (int i = 0; i < craftingRecipeInput.getSize(); i++) {
            ...
            if (!itemStack3.isEmpty()) {
                if (itemStack3.getItem() instanceof BannerItem) {
                    ...
                    if (!itemStack3.isOf(MiniumItem.MINIUM_SHIELD)) {
                        return false;
                    }
    ...
    public ItemStack craft(CraftingRecipeInput craftingRecipeInput, RegistryWrapper.WrapperLookup wrapperLookup) {
        ...
        for (int i = 0; i < craftingRecipeInput.getSize(); i++) {
            ...
            if (!itemStack3.isEmpty()) {
                if (itemStack3.getItem() instanceof BannerItem) {
                    itemStack = itemStack3;
                } else if (itemStack3.isOf(MiniumItem.MINIUM_SHIELD)) {
    ...
    public RecipeSerializer<?> getSerializer() {
        return MiniumSpecialRecipes.MINIUM_SHIELD_DECORATION;
    }
}
